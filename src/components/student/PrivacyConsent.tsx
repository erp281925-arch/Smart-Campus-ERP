...
+import { Shield, Check, X, Eye, EyeOff, Info, Lock, Users } from 'lucide-react';
...
+                  <span>Your data is protected. Staff and advisors will see "Access Denied" when trying to view your detailed analytics.</span>
+                </p>
+              </div>
+            )}
          </div>
...
+      {/* Privacy Impact Information */}
+      <Card className="dashboard-card bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
+        <CardContent className="p-6">
+          <div className="flex items-start space-x-4">
+            <Info className="w-6 h-6 text-blue-600 mt-1" />
+            <div>
+              <h3 className="text-lg font-semibold text-blue-800 mb-2">How This Affects Your Experience</h3>
+              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
+                <div>
+                  <h4 className="font-medium text-blue-700 mb-2">When Data Sharing is Enabled:</h4>
+                  <ul className="text-sm text-blue-600 space-y-1">
+                    <li>• Staff can view your wellness metrics</li>
+                    <li>• Proactive support and interventions</li>
+                    <li>• Personalized academic guidance</li>
+                    <li>• Early identification of challenges</li>
+                  </ul>
+                </div>
+                <div>
+                  <h4 className="font-medium text-blue-700 mb-2">When Data Sharing is Disabled:</h4>
+                  <ul className="text-sm text-blue-600 space-y-1">
+                    <li>• Staff see "Access Denied" message</li>
+                    <li>• Your privacy is fully protected</li>
+                    <li>• You can still access all features</li>
+                    <li>• Support available on request only</li>
+                  </ul>
+                </div>
+              </div>
+            </div>
...
+              <div>
+                <h4 className="font-medium text-gray-800">Staff Access Control</h4>
+                <p className="text-sm text-gray-600">When consent is denied, staff see "Access Denied" instead of your data.</p>
+              </div>
+            </div>
          </div>
        </CardContent>
